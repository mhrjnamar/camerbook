                                ...
                                children: <Widget>[
                                  new Flexible(
                                    child: new TextField(
                                      ...
                                      decoration:  InputDecoration(
                                          hintText: data['contact'].toString()),
                                      enabled: !_status,
                                    ),
                                  ),
                                ],
              ...
              child: Container(
                ...
                onPressed: () {
                  setState(() {
                    ...
                    context.read<Backend>().addProfile(
                      new ProfileModel(name: nameController.text,email: email,contact: int.parse(mobileController.text),pincode: int.parse(pincodeController.text), state: stateController.text),
                      uid
                    );
